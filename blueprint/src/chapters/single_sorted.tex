...
\begin{proof}
  ...
  \refaxiom{def:PreSingleSortedCategory}{ax:ss_glob}, we have that
  \[
...
\begin{definition}[Composition of single-sorted functors]
...
\begin{definition}[Identity single-sorted functor]
...
\begin{proof}
  ...
  \cref{def:SingleSortedFunctor_comp,def:SingleSortedFunctor_id}, respectively. The required
  category laws trivially follow from the corresponding properties of function composition.
\end{proof}

\begin{definition}[Category of single-sorted finite categories]
  ...
  by $n\Cat$, is the particular case of \cref{def:SingleSortedCategory_category} where $\Index$ is
  the finite set $n$. Its objects are single-sorted $n$-categories and its morphisms are
...
\begin{definition}[Category of single-sorted omega categories]
  ...
  particular case of \cref{def:SingleSortedCategory_category} where $\Index$ is the set of natural
  numbers $\NN$. Its objects are single-sorted $\omega$-categories and its morphisms are
