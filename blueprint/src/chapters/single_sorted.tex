...
\begin{construction}[Category of single-sorted omega categories]
  ...
  form a subclass of those of $\NN\Cat$. The categorical structure (composition, identity, and laws),
  however, is inherited directly.} of Definition~\ref{def:SingleSortedCategory_category} where
  $\Index$ is the set of natural numbers $\NN$. Its objects are single-sorted $\omega$-categories and
  its morphisms are single-sorted $\omega$-functors.
\end{construction}
