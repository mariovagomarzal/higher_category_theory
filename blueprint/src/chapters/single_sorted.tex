...
\begin{construction}[Category of single-sorted omega categories]
  ...
  particular case of Definition~\ref{def:SingleSortedCategory_category} where $\Index$ is the set of
  natural numbers $\NN$. Its objects are single-sorted $\omega$-categories and its morphisms are
  single-sorted $\omega$-functors.
\end{construction}
