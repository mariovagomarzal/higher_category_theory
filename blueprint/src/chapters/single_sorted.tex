...
\begin{definition}[Cell]
  \label{def:cell}
  \uses{def:SingleSortedCategory}
  \lean{ HigherCategoryTheory.SingleSorted.cell, HigherCategoryTheory.SingleSorted.cell_sc, HigherCategoryTheory.SingleSorted.cells,
...
\begin{theorem}[Equivalence of cell definitions]
  ...
  \lean{HigherCategoryTheory.SingleSorted.cell_sc_iff_cell_tg, HigherCategoryTheory.SingleSorted.cells_sc_eq_cells_tg}
  \leanok
  Let $\cat{C}$ be a single-sorted $\Index$-category and $k \in \Index$. A morphism $f \in C$ is a
