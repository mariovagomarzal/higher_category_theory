...
\begin{proof}
  \leanok
  Composition and the identity functor are well defined by Theorems~\ref{thm:ManySortedFunctor_comp}
  and~\ref{thm:ManySortedFunctor_id}, respectively. The required category laws trivially follow from
