...
\begin{definition}[Category of many-sorted finite categories]
  ...
  $n\CatMS$, is the particular case of \cref{def:ManySortedCategory_category} where $\Index$ is the
  finite set $n + 1 = \set{0, 1, \ldots, n}$. Its objects are many-sorted $n$-categories and its
  morphisms are many-sorted $n$-functors.
\end{definition}
...
\begin{definition}[Category of many-sorted omega categories]
  ...
  particular case of \cref{def:ManySortedCategory_category} where $\Index$ is the set of natural
  numbers $\NN$. Its objects are many-sorted $\omega$-categories and its morphisms are many-sorted
  $\omega$-functors.
\end{definition}
