...
\begin{proof}
  ...
  \]
  where both equalities use \refaxiom{def:PreManySortedCategory}{ax:ms_sc_tg_idm}.
\end{proof}
...
\begin{proof}
  ...
  \cref{def:ManySortedFunctor_comp,def:ManySortedFunctor_id}, respectively. The required category
  laws trivially follow from the corresponding properties of function composition.
\end{proof}
...
\begin{definition}[Category of many-sorted omega categories]
  ...
  analogously to \cref{def:ManySortedCategory_category}, but using many-sorted $\omega$-categories
  and many-sorted $\omega$-functors instead.
\end{definition}

\begin{proof}
  \leanok
  As in \cref{def:ManySortedCategory_category}, the required category laws trivially follow from the
  corresponding properties of function composition.
\end{proof}
