...
\begin{definition}[Many-sorted category]
  ...
  \begin{definition}[Pre-many-sorted one-categories lifting]
    \label{def:PreManySortedCategoryLift}
...
\begin{construction}[Composition of many-sorted functors]
...
\begin{construction}[Identity many-sorted functor]
...
\begin{construction}[Category of many-sorted categories]
...
\begin{construction}[Category of many-sorted finite categories]
...
\begin{proof}
  \leanok
  This is a particular case of Definition~\ref{def:ManySortedCategory_category}, so the result
  follows immediately.
\end{proof}

\begin{construction}[Category of many-sorted omega categories]
...
\begin{notation}
  We extend the notation $n\CatMS$ to all $n \in \ENat$, understanding that,
  \begin{itemize}
    \item if $n \in \NN$, this is the category $n\CatMS$ of
      Definition~\ref{def:ManySortedNCategory_category}, and
    \item if $n = \omega$, this denotes $\omega\CatMS$ of
      Definition~\ref{def:ManySortedOmegaCategory_category}.
  \end{itemize}
\end{notation}
